 ...
 * @since 1.0.0
 */
add_action('widgets_init', 'pbc24com_register_families_list_widget');

function pbc24com_register_families_list_widget() {
    register_widget('Pbc24com_Families_List');
}

class Pbc24com_Families_List extends WP_widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'Pbc24com_Families_List',
            'description' => __('Display latest or random posts in list view.', 'pbc24com')
        );
        parent::__construct('pbc24com_families_list', __('PBC24com: Families Lists', 'pbc24com'), $widget_ops);
    }
